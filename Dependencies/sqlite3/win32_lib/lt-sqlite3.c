...
/* ./.libs/lt-sqlite3.c - temporary wrapper executable for .libs/sqlite3.exe
...
const char * LIB_PATH_VALUE   = "c:\\Users\\Kiseitai2\\Documents\\DevCB\\Engine_Eureka\\Dependencies_and_tools\\sqlite3\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "c:\\Users\\Kiseitai2\\Documents\\DevCB\\Engine_Eureka\\Dependencies_and_tools\\sqlite3\\.libs;C:\\MinGW\\msys\\1.0\\local\\lib;C:\\MinGW\\msys\\1.0\\local\\bin;";
const char * TARGET_PROGRAM_NAME = "sqlite3.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sqlite3 - temporary wrapper script for .libs/sqlite3.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The sqlite3 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ./libsqlite3.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"sqlite3.exe:sqlite3:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sqlite3.exe:sqlite3:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sqlite3.exe:sqlite3:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
  ...
  fputs ("    PATH=/c/Users/Kiseitai2/Documents/DevCB/Engine_Eureka/Dependencies_and_tool", f);
  fputs ("s/sqlite3/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/Kiseitai2/Documents/DevCB/Engine_Eureka/Dependencies_and_too", f);
  fputs ("ls/sqlite3/.libs:$PATH\"\n", f);
  fputs ("\n", f);
