...
public:
    ...
    or list! :D*/
    int lua_extractInt(lua_State *results);
    char lua_extractChar(lua_State *results);
    std::string lua_extractStr(lua_State *results);
    double lua_extractDouble(lua_State *results);
    void *lua_extractPtr(lua_State *results);
    int lua_extractIntFromList(lua_State *results, unsigned int index);
    std::string lua_extractStrFromList(lua_State *results, unsigned int index);
    char lua_extractCharFromList(lua_State *results, unsigned int index);
    double lua_extractDoubleFromList(lua_State *results, unsigned int index);
    void *lua_extractPtrFromList(lua_State *results, unsigned int index);
